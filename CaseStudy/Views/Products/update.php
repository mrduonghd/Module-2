        ...
        <div class="card">
            ...
            <form class="p-3 mb-2 bg-dark text-white" action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-6 container">
                    ...
                    <input type="text" class="form-control text-center" id="inputD" name="vendor" value="<?php echo $product['pVendor'] ?>">

                </div>
                <div class="col-6 container">
                    <label for="inputA" class="form-label">Description</label>
                    <input type="text" class="form-control text-center" id="inputA" name="description" value="<?php echo $product['pDescription'] ?>">
                </div>
                <div class="col-6 container">
                    <label for="inputJ" class="form-label">Price</label>
                    <input type="text" class="form-control text-center" id="inputJ" name="price" value="<?php echo $product['buyPrice'] ?>">

                </div>
                <div class="col-6 container">
                    <label for="inputJs" class="form-label">Image</label>
                    <input type="file" class="form-control text-center" id="inputJs" name="img" value="<?php echo $product['img'] ?>">
