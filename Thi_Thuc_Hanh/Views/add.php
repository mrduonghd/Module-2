        ...
        <div class="card">
            ...
            <form class="p-3 mb-2 bg-dark text-white" action="" method="POST">
                ...
                <div class="col-6 container">
                    ...
                    <input type="text" class="form-control text-center" id="inputD" name="type" placeholder="Type">

                </div>
                <div class="col-6 container">
                    <label for="inputA" class="form-label">Price</label>
                    <input type="text" class="form-control text-center" id="inputA" name="price" placeholder="Price">
                </div>
                <div class="col-6 container">
                    <label for="inputJ" class="form-label">Quantity</label>
                    <input type="text" class="form-control text-center" id="inputJ" name="quantity" placeholder="Quantity">

                </div>
                <div class="col-6 container">
                    <label for="inputJs" class="form-label">Date Created</label>
                    <input type="date" class="form-control text-center" id="inputJs" name="date">

                </div>
                <div class="col-6 container">
                    <label for="inputJ" class="form-label">Description</label>
                    <input type="text" class="form-control text-center" id="inputJ" name="description" placeholder="Description">
